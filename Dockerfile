FROM debian:jessie
MAINTAINER Junv Zhao <wahyd4@gmail.com>
...
RUN /pinpoint/quickstart/bin/init-hbase.sh

RUN /pinpoint/quickstart/bin/start-collector.sh
RUN /pinpoin/quickstart/bin/start-web.sh
